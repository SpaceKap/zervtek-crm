...
- **Endpoint:** `GET /api/cron/release-assignments`
- **Purpose:** Releases inquiries that have been assigned for more than 30 days without conversion.

### Stock Listings Auto-Delete
